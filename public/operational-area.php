...
<head>
    ...
    <title>Área Operacional | Gestão de Expedientes</title>
    <link rel="stylesheet" href="assets/css/style.css">
</head>
<body class="app-page">
    <main class="dashboard-shell">
        <p class="section-kicker">Demonstração RBAC</p>
        <h1>Área operacional autorizada</h1>
        <p class="muted">Esta área exige a permissão <strong>expedientes.manage</strong>, consultada diretamente na base de dados.</p>
